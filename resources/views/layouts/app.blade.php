        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="{{asset('images/shards-dashboards-logo.svg')}}" alt="{{config('app.name', 'Virbro')}} Dashboard">
                  <span class="d-none d-md-inline ml-1">{{config('app.name', 'Virbro')}} Dashboard</span>
                </div>
              </a>
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link " href="/home/insured">
              ...
              <li class="nav-item">
                <a class="nav-link " href="/home/claims">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
              ...
              <ul class="navbar-nav border-left flex-row mr-0">
        ...
        <!-- End Page Header -->
         ...
         @yield('content')
          ...
          <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
            <!-- include('inc.nav') -->
            <span class="copyright ml-auto my-auto mr-2">Copyright © 2019 Team-Purpose</a>
            </span>
          </footer>
        </main>
      </div>
